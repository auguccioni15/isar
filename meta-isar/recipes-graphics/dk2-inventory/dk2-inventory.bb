...
# (libsqlite3-0 listed explicitly to be safe). The Magazzino tile only
# appears in dk2-launcher's grid when this package is installed.
DEBIAN_DEPENDS = "python3-gi, gir1.2-gtk-3.0, libsqlite3-0"
